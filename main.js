...
let arrayPersons = [
    ...
    ["images/interests/burger.jpg", "images/interests/musik.jpg", "images/interests/tennis.jpg", "images/interests/got.jpg"], true, "keine", "profil_robin.html"),
    new Person("Hannah", "Nachname", 23, "Duisburg", "images/profile_hannah.jpg", 15, 400,
    ["images/interests/eis.jpg", "images/interests/shopping.jpg", "images/interests/surfen.jpg", "images/interests/champagne.jpg"], false, "keine", "profil_hannah.html"),
    new Person("Emilie", "Nachname", 19, "Duisburg", "images/profile_emilie.jpg", 12, 320,
    ["images/interests/hantel.jpg", "images/interests/fussball.jpg", "images/interests/kamera.jpg", "images/interests/backpack.jpg"], false, "keine", "#"),
    new Person("Hannah", "Nachname", 23, "Duisburg", "images/profile_karl.jpg", 15, 400,
    ["images/interests/fahrrad.jpg", "images/interests/roller.jpg", "images/interests/waffel.jpg", "images/interests/klavier.jpg"], false, "keine", "#")
];
...
/*
    ...
    $("body").on("mouseenter",".container-profile", function() {
        //alert(3);
        document.body.style.cursor="pointer";
        $(event.target).css({zIndex: 100});
        $("#dark-background").fadeTo(100,0.5);
    });

    $("body").on("mouseleave",".container-profile", function() {
        //alert(4);
        $(event.target).css({zIndex: 100});
        document.body.style.cursor="default";
        $("#dark-background").hide();
